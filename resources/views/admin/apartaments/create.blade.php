    ...
    <div class="container mt-5 mb-5">
        <div class="row d-flex justify-content-center">
            <div class="col-8 add-product">
                ...
                <hr>
                <form action="adminapartments.store" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row form-group">
                        ...
                        <input type="number" min="1" class="form-control col-12 col-md-9 @error('stanze') is-invalid @enderror" id="stanze" placeholder="Numero di stanze" name="stanze" value="{{ old('stanze') }}" required>
                        @error('stanze')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row form-group">
                        ...
                        <input type="number" min="1" class="form-control col-12 col-md-9 @error('posti_letto') is-invalid @enderror" id="posti_letto" placeholder="Numero di posti letto" name="posti_letto" value="{{ old('posti_letto') }}" required>
                        @error('posti_letto')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row form-group">
                      ...
                      <textarea type="text" class="form-control col-12 col-md-9" id="descrizione" placeholder="Descrizione" name="descrizione" rows="5">{{ old('descrizione') }}</textarea required>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <input class="col-12 col-md-9" type="file" class="form-control-file" id="img-1" name="img-1" required>
